...
// clxx/common/detail/path.hpp

/** // doc: clxx/common/detail/path.hpp {{{
 * \file clxx/common/detail/path.hpp
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_COMMON_DETAIL_PATH_HPP_INCLUDED
#define CLXX_COMMON_DETAIL_PATH_HPP_INCLUDED
...
#endif /* CLXX_COMMON_DETAIL_PATH_HPP_INCLUDED */
