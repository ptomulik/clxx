...
// clxx/common/compiler_config.hpp

/** // doc: clxx/common/compiler_config.hpp {{{
 * \file clxx/common/compiler_config.hpp
 * \brief Configuration and preprocessor macros used across clxx project
 */ // }}}
#ifndef CLXX_COMMON_COMPILER_CONFIG_HPP_INCLUDED
#define CLXX_COMMON_COMPILER_CONFIG_HPP_INCLUDED
...
#endif /* CLXX_COMMON_COMPILER_CONFIG_HPP_INCLUDED */
