...
// clxx/b5d/mocks/functions.hpp

/** // doc: clxx/b5d/mocks/functions.hpp {{{
 * \file clxx/b5d/mocks/functions.hpp
 *
 ...
 */ // }}}
#ifndef CLXX_B5D_MOCKS_FUNCTIONS_HPP_INCLUDED
#define CLXX_B5D_MOCKS_FUNCTIONS_HPP_INCLUDED
