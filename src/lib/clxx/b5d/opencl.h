...
/** // doc: clxx/b5d/opencl.h {{{
 * \file clxx/b5d/opencl.h
...
/////////////////////////////////////////////////////////////////////////////
#if defined(CLXX_B5D_OPENCL_CL_H_VERSION_1_0) && !defined(CL_VERSION_1_0)
# error "clxx must be compiled with CL/cl.h version at least 1.0"
#endif
#if defined(CLXX_B5D_OPENCL_CL_H_VERSION_1_1) && !defined(CL_VERSION_1_1)
# error "clxx must be compiled with CL/cl.h version at least 1.1"
#endif
#if defined(CLXX_B5D_OPENCL_CL_H_VERSION_1_2) && !defined(CL_VERSION_1_2)
# error "clxx must be compiled with CL/cl.h version at least 1.2"
#endif
#if defined(CLXX_B5D_OPENCL_CL_H_VERSION_2_0) && !defined(CL_VERSION_2_0)
...
#endif /* CLXX_B5D_OPENCL_H_INCLUDED */
