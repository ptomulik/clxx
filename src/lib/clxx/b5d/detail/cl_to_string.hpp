...
// clxx/b5d/detail/cl_to_string.hpp

/** // doc: clxx/b5d/detail/cl_to_string.hpp {{{
 * \file clxx/b5d/detail/cl_to_string.hpp
...
#endif /* CLXX_B5D_DETAIL_CL_TO_STRING_HPP_INCLUDED */
