...
// clxx/b5d/detail/clerror_stdexcept.hpp

/** // doc: clxx/b5d/detail/clerror_stdexcept.hpp {{{
 * \file clxx/b5d/detail/clerror_stdexcept.hpp
...
#endif /* CLXX_B5D_DETAIL_CLERROR_STDEXCEPT_HPP_INCLUDED */
