...
// clxx/i2o/platform_layer_info.hpp

/** // doc: clxx/i2o/platform_layer_info.hpp {{{
 * \file clxx/i2o/platform_layer_info.hpp
 * \brief Defines \ref clxx::platform_layer_info "platform_layer_info" class
 */ // }}}
#ifndef CLXX_I2O_PLATFORM_LAYER_INFO_HPP_INCLUDED
#define CLXX_I2O_PLATFORM_LAYER_INFO_HPP_INCLUDED

#include <clxx/i2o/platform_info_ptrs.hpp>
#include <clxx/i2o/device_info_ptrs.hpp>
...
#endif /* CLXX_I2O_PLATFORM_LAYER_INFO_HPP_INCLUDED */
