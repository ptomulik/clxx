...
// clxx/i2o/platform_info_ptr.hpp

/** // doc: clxx/i2o/platform_info_ptr.hpp {{{
 * \file clxx/i2o/platform_info_ptr.hpp
 * \brief Defines \ref clxx::platform_info_ptr "platform_info_ptr"
 */ // }}}
#ifndef CLXX_I2O_PLATFORM_INFO_PTR_HPP_INCLUDED
#define CLXX_I2O_PLATFORM_INFO_PTR_HPP_INCLUDED

#include <clxx/c4n/shared_ptr.hpp>
...
#endif /* CLXX_I2O_PLATFORM_INFO_PTR_HPP_INCLUDED */
