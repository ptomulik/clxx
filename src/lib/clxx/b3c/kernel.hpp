...
/** // doc: clxx/b3c/kernel.hpp {{{
 * \file clxx/b3c/kernel.hpp
 * \brief Defines the \ref clxx::kernel "kernel" class
 */ // }}}
#ifndef CLXX_B3C_KERNEL_HPP_INCLUDED
#define CLXX_B3C_KERNEL_HPP_INCLUDED
...
#endif /* CLXX_B3C_KERNEL_HPP_INCLUDED */
