...
// clxx/b3c/detail/context_property_type.hpp

/** // doc: clxx/b3c/detail/context_property_type.hpp {{{
 * \file clxx/b3c/detail/context_property_type.hpp
...
#endif /* CLXX_B3C_DETAIL_CONTEXT_PROPERTY_TYPE_HPP_INCLUDED */
