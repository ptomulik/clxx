...
// clxx/b3c/device_partition.hpp

/** // doc: clxx/b3c/device_partition.hpp {{{
 * \file clxx/b3c/device_partition.hpp
 * \brief Declares clxx API for \ref clxx::device "device" partitioning
 */ // }}}
#ifndef CLXX_B3C_DEVICE_PARTITION_HPP_INCLUDED
#define CLXX_B3C_DEVICE_PARTITION_HPP_INCLUDED
