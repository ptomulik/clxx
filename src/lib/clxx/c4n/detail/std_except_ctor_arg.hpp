...
// clxx/c4n/detail/std_except_ctor_arg.hpp

/** // doc: clxx/c4n/detail/std_except_ctor_arg.hpp {{{
 * \file clxx/c4n/detail/std_except_ctor_arg.hpp
 * \brief Defines the \ref clxx::std_except_ctor_arg "std_except_ctor_arg" meta-function
 */ // }}}
#ifndef CLXX_C4N_DETAIL_STD_EXCEPT_CTOR_ARG_HPP_INCLUDED
#define CLXX_C4N_DETAIL_STD_EXCEPT_CTOR_ARG_HPP_INCLUDED

#include <clxx/c4n/detail/std_except_ctor_arg_fwd.hpp>
#include <stdexcept>
#include <new>
...
#endif /* CLXX_C4N_DETAIL_STD_EXCEPT_CTOR_ARG_HPP_INCLUDED */
