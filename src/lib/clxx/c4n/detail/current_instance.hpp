...
// clxx/c4n/detail/current_instance.hpp

/** // doc: clxx/c4n/detail/current_instance.hpp {{{
 * \file clxx/c4n/detail/current_instance.hpp
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_C4N_DETAIL_CURRENT_INSTANCE_HPP_INCLUDED
#define CLXX_C4N_DETAIL_CURRENT_INSTANCE_HPP_INCLUDED

#include <clxx/c4n/current_instance.hpp>
 ...
 * the \c load_program():
 *
 * \snippet clxx/c4n/current_instance1.cpp LoadProgramFcn
 *
 ...
 *
 * \snippet clxx/c4n/current_instance1.cpp CurrentPathClass
 *
 ...
 *    \snippet clxx/c4n/current_instance1.cpp BindStaticInstance
 *  - bind the thread local instance (maintained internally by the class):
 *    \snippet clxx/c4n/current_instance1.cpp BindThreadInstance
 *  - bind a user provided instance:
 *    \snippet clxx/c4n/current_instance1.cpp BindUserInstance
 *
 *
...
#endif /* CLXX_C4N_DETAIL_CURRENT_INSTANCE_HPP_INCLUDED */
