...
// clxx/c4n/exception.hpp

/** // doc: clxx/c4n/exception.hpp {{{
 * \file clxx/c4n/exception.hpp
 * \brief Provides the clxx::exception class.
 */ // }}}
#ifndef CLXX_C4N_EXCEPTION_HPP_INCLUDED
#define CLXX_C4N_EXCEPTION_HPP_INCLUDED
 ...
 *    following snippet
 *
 *    \snippet clxx/c4n/exception2.cpp ExceptionDefinition
 *
 ...
 *
 *      \snippet clxx/c4n/exception1.cpp CatchClxxException1
 *
 *    - as a clxx::exception:
 *
 *      \snippet clxx/c4n/exception1.cpp CatchClxxException
 *
 *    - as a std::runtime_error
 *
 *      \snippet clxx/c4n/exception1.cpp CatchStdRuntimeError
 *
 *    - as a std::exception:
 *
 *      \snippet clxx/c4n/exception1.cpp CatchStdException
 *
 *    - you may also catch exceptions "by priority", starting from most
 *      particular ones and falling-back to more generic ones:
 *
 *      \snippet clxx/c4n/exception1.cpp CatchHierarchy
 *
...
#endif /* CLXX_C4N_EXCEPTION_HPP_INCLUDED */
