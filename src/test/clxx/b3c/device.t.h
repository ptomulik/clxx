...
/** // doc: clxx/b3c/device.t.h {{{
 * \file clxx/b3c/device.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B3C_DEVICE_T_H_INCLUDED
#define CLXX_B3C_DEVICE_T_H_INCLUDED
...
#endif /* CLXX_B3C_DEVICE_T_H_INCLUDED */
