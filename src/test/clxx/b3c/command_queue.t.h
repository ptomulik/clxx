...
// clxx/b3c/command_queue.t.h

/** // doc: clxx/b3c/command_queue.t.h {{{
 * \file clxx/b3c/command_queue.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B3C_COMMAND_QUEUE_T_H_INCLUDED
#define CLXX_B3C_COMMAND_QUEUE_T_H_INCLUDED
...
#elif CLXX_B5D_OPENCL_PROVIDES(clCreateCommandQueue)
    T::Dummy_clCreateCommandQueue mock1((cl_command_queue)0, CL_SUCCESS);
#else
# error neither clCreateCommandQueue nor clCreateCommandQueueWithProperties is defined, this should never happen!
#endif
...
#endif /* CLXX_B3C_COMMAND_QUEUE_T_H_INCLUDED */
