...
// clxx/b5d/functions_config.t.h

/** // doc: clxx/b5d/functions_config.t.h {{{
 * \file clxx/b5d/functions_config.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_FUNCTIONS_CONFIG_T_H_INCLUDED
#define CLXX_B5D_FUNCTIONS_CONFIG_T_H_INCLUDED

#include <cxxtest/TestSuite.h>
#include <clxx/b5d/functions_config.hpp>

namespace clxx { class functions_config_test_suite; }

/** // doc: class clxx::functions_config_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::functions_config_test_suite : public CxxTest::TestSuite
{
public:
...
#endif /* CLXX_B5D_FUNCTIONS_CONFIG_T_H_INCLUDED */
