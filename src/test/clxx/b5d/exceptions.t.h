...
// clxx/b5d/exceptions.t.h

/** // doc: clxx/b5d/exceptions.t.h {{{
 * \file clxx/b5d/exceptions.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_EXCEPTIONS_T_H_INCLUDED
#define CLXX_B5D_EXCEPTIONS_T_H_INCLUDED

#include <cxxtest/TestSuite.h>
#include <clxx/b5d/exceptions.hpp>

namespace clxx { class exceptions_test_suite; }

/** // doc: class clxx::exceptions_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::exceptions_test_suite : public CxxTest::TestSuite
{
public:
...
#endif /* CLXX_B5D_EXCEPTIONS_T_H_INCLUDED */
