...
// clxx/b5d/detail/cl_enum2name.t.h

/** // doc: clxx/b5d/detail/cl_enum2name.t.h {{{
 * \file clxx/b5d/detail/cl_enum2name.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_DETAIL_CL_ENUM2NAME_T_H_INCLUDED
#define CLXX_B5D_DETAIL_CL_ENUM2NAME_T_H_INCLUDED

#include <cxxtest/TestSuite.h>
#include <clxx/b5d/detail/cl_enum2name.hpp>

namespace clxx { namespace detail { class cl_enum2name_test_suite; } }

/** // doc: class clxx::detail::cl_enum2name_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::detail::cl_enum2name_test_suite : public CxxTest::TestSuite
{
public:
  /** // doc: test_status_t() {{{
...
#endif /* CLXX_B5D_DETAIL_CL_ENUM2NAME_T_H_INCLUDED */
