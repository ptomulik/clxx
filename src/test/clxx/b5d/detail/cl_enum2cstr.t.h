...
// clxx/b5d/detail/cl_enum2cstr.t.h

/** // doc: clxx/b5d/detail/cl_enum2cstr.t.h {{{
 * \file clxx/b5d/detail/cl_enum2cstr.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_DETAIL_CL_ENUM2CSTR_T_H_INCLUDED
#define CLXX_B5D_DETAIL_CL_ENUM2CSTR_T_H_INCLUDED

#include <cxxtest/TestSuite.h>
#include <clxx/b5d/detail/cl_enum2cstr.hpp>

namespace clxx { namespace detail { class cl_enum2cstr_test_suite; } }

/** // doc: class clxx::detail::cl_enum2cstr_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::detail::cl_enum2cstr_test_suite : public CxxTest::TestSuite
{
public:
  /** // doc: test_status_t() {{{
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<status_t>(0x7FFF)), static_cast<const void*>(nullptr));
    TS_ASSERT_EQUALS(enum2cstr(static_cast<status_t>(-0x7FFF)), static_cast<const void*>(nullptr));
  }
  ...
  void test_platform_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<platform_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_device_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_fp_config_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_device_mem_cache_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_mem_cache_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_device_local_mem_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_local_mem_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_device_exec_capabilities_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_exec_capabilities_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_command_queue_properties_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<command_queue_properties_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<context_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<context_properties_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_device_partition_property_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_partition_property_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_device_affinity_domain_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<device_affinity_domain_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_command_queue_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<command_queue_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<mem_flags_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_mem_migration_flags_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<mem_migration_flags_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<channel_order_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<channel_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<mem_object_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
  /** // doc: test_mem_info_t() {{{
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<mem_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<image_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<addressing_mode_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_filter_mode_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<filter_mode_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_sampler_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<sampler_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<map_flags_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<program_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<program_build_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_program_binary_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<program_binary_type_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_build_status_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<build_status_t>(-12345l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_kernel_arg_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_arg_info_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_kernel_arg_address_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_arg_address_qualifier_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_kernel_arg_access_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_arg_access_qualifier_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_kernel_arg_type_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_arg_type_qualifier_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<kernel_work_group_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<event_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
...
#endif
    TS_ASSERT_EQUALS(enum2cstr(static_cast<command_type_t>(-1l)), static_cast<const void*>(nullptr));
  }
  ...
  void test_command_exec_status_t( )
  {
    ...
    // unknown state
    //
    TS_ASSERT_EQUALS(enum2cstr(static_cast<command_exec_status_t>(0x7FFF)), static_cast<const void*>(nullptr));
    //
  ...
  void test_buffer_create_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<buffer_create_type_t>(-1l)), static_cast<const void*>(nullptr));
#endif
  }
  ...
  void test_profiling_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(enum2cstr(static_cast<profiling_info_t>(-1l)), static_cast<const void*>(nullptr));
  }
};

#endif /* CLXX_B5D_DETAIL_CL_ENUM2CSTR_T_H_INCLUDED */
