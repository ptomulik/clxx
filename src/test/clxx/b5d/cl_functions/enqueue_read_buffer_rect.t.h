...
// clxx/b5d/cl_functions/enqueue_read_buffer_rect.t.h

/** // doc: clxx/b5d/cl_functions/enqueue_read_buffer_rect.t.h {{{
 * \file clxx/b5d/cl_functions/enqueue_read_buffer_rect.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_RECT_T_H_INCLUDED
#define CLXX_B5D_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_RECT_T_H_INCLUDED
...
namespace  clxx { class enqueue_read_buffer_rect_test_suite; }

/** // doc: class clxx::enqueue_read_buffer_rect_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::enqueue_read_buffer_rect_test_suite : public CxxTest::TestSuite
{
public:
  ////////////////////////////////////////////////////////////////////////////
  ...
  void test__enqueue_read_buffer_rect( )
  {
    ...
    TS_ASSERT(mock.called_once_with(  (cl_command_queue)0x123,
                                      ...
                                      (cl_event*)0x901) );
#else
    TS_SKIP("enqueue_read_buffer_rect not implemented");
#endif
  }
...
#endif /* CLXX_B5D_CL_FUNCTIONS_ENQUEUE_READ_BUFFER_RECT_T_H_INCLUDED */
