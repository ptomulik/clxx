...
// clxx/b5d/cl_functions/enqueue_copy_image_to_buffer.t.h

/** // doc: clxx/b5d/cl_functions/enqueue_copy_image_to_buffer.t.h {{{
 * \file clxx/b5d/cl_functions/enqueue_copy_image_to_buffer.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_CL_FUNCTIONS_ENQUEUE_COPY_IMAGE_TO_BUFFER_T_H_INCLUDED
#define CLXX_B5D_CL_FUNCTIONS_ENQUEUE_COPY_IMAGE_TO_BUFFER_T_H_INCLUDED
...
namespace  clxx { class enqueue_copy_image_to_buffer_test_suite; }

/** // doc: class clxx::enqueue_copy_image_to_buffer_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::enqueue_copy_image_to_buffer_test_suite : public CxxTest::TestSuite
{
public:
  ////////////////////////////////////////////////////////////////////////////
  ...
  void test__enqueue_copy_image_to_buffer( )
  {
    ...
    TS_ASSERT(mock.called_once_with(  (cl_command_queue)0x123,
                                      ...
                                      (cl_event*)0x901) );
#else
    TS_SKIP("enqueue_copy_image_to_buffer not implemented");
#endif
  }
...
#endif /* CLXX_B5D_CL_FUNCTIONS_ENQUEUE_COPY_IMAGE_TO_BUFFER_T_H_INCLUDED */
