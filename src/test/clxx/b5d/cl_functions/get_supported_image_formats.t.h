...
// clxx/b5d/cl_functions/get_supported_image_formats.t.h

/** // doc: clxx/b5d/cl_functions/get_supported_image_formats.t.h {{{
 * \file clxx/b5d/cl_functions/get_supported_image_formats.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_CL_FUNCTIONS_GET_SUPPORTED_IMAGE_FORMATS_T_H_INCLUDED
#define CLXX_B5D_CL_FUNCTIONS_GET_SUPPORTED_IMAGE_FORMATS_T_H_INCLUDED
...
namespace  clxx { class get_supported_image_formats_test_suite; }

/** // doc: class clxx::get_supported_image_formats_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::get_supported_image_formats_test_suite : public CxxTest::TestSuite
{
public:
  ////////////////////////////////////////////////////////////////////////////
...
#else
    TS_SKIP("get_supported_image_formats not implemented");
#endif
  }
...
#endif /* CLXX_B5D_CL_FUNCTIONS_GET_SUPPORTED_IMAGE_FORMATS_T_H_INCLUDED */
