...
// clxx/b5d/cl_functions/create_program_with_source.t.h

/** // doc: clxx/b5d/cl_functions/create_program_with_source.t.h {{{
 * \file clxx/b5d/cl_functions/create_program_with_source.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_B5D_CL_FUNCTIONS_CREATE_PROGRAM_WITH_SOURCE_T_H_INCLUDED
#define CLXX_B5D_CL_FUNCTIONS_CREATE_PROGRAM_WITH_SOURCE_T_H_INCLUDED
...
namespace  clxx { class create_program_with_source_test_suite; }

/** // doc: class clxx::create_program_with_source_test_suite {{{
 * \todo Write documentation
 */ // }}}
class clxx::create_program_with_source_test_suite : public CxxTest::TestSuite
{
public:
  ////////////////////////////////////////////////////////////////////////////
...
#else
    TS_SKIP("create_program_with_source not implemented");
#endif
  }
...
#endif /* CLXX_B5D_CL_FUNCTIONS_CREATE_PROGRAM_WITH_SOURCE_T_H_INCLUDED */
