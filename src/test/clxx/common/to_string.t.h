 ...
 */ // }}}
#ifndef CLXX_COMMON_TO_STRING_T_H_INCLUDED
#define CLXX_COMMON_TO_STRING_T_H_INCLUDED
...
public:
  ...
  void test_status_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<status_t>(0x1234)), detail::enum2hex(static_cast<status_t>(0x1234)));
  }
  ...
  void test_platform_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<platform_info_t>(0x1234)), detail::enum2hex(static_cast<platform_info_t>(0x1234)));
  }
  ...
  void test_device_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_type_t>(0x1200)), detail::enum2hex(static_cast<device_type_t>(0x0200)) + " | " + detail::enum2hex(static_cast<device_type_t>(0x1000)));
  }
  ...
  void test_device_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_info_t>(0x1234)), detail::enum2hex(static_cast<device_info_t>(0x1234)));
  }
  ...
  void test_device_fp_config_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_fp_config_t>(0x1200)), detail::enum2hex(static_cast<device_fp_config_t>(0x0200)) + " | " + detail::enum2hex(static_cast<device_fp_config_t>(0x1000)));
  }
  ...
  void test_device_mem_cache_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_mem_cache_type_t>(0x1234)), detail::enum2hex(static_cast<device_mem_cache_type_t>(0x1234)));
  }
  ...
  void test_device_local_mem_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_local_mem_type_t>(0x1234)), detail::enum2hex(static_cast<device_local_mem_type_t>(0x1234)));
  }
  ...
  void test_device_exec_capabilities_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_exec_capabilities_t>(0x1200)), detail::enum2hex(static_cast<device_exec_capabilities_t>(0x0200)) + " | " + detail::enum2hex(static_cast<device_exec_capabilities_t>(0x1000)));
  }
  ...
  void test_command_queue_properties_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<command_queue_properties_t>(0x1200)), detail::enum2hex(static_cast<command_queue_properties_t>(0x0200)) + " | " + detail::enum2hex(static_cast<command_queue_properties_t>(0x1000)));
  }
  ...
  void test_context_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<context_info_t>(0x1234)), detail::enum2hex(static_cast<context_info_t>(0x1234)));
  }
  ...
  void test_context_properties_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<context_properties_t>(0x1234)), detail::enum2hex(static_cast<context_properties_t>(0x1234)));
  }
  ...
  void test_device_partition_property_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_partition_property_t>(0x1234)), detail::enum2hex(static_cast<device_partition_property_t>(0x1234)));
#endif
  }
  ...
  void test_device_affinity_domain_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<device_affinity_domain_t>(0x1200)), detail::enum2hex(static_cast<device_affinity_domain_t>(0x0200)) + " | " + detail::enum2hex(static_cast<device_affinity_domain_t>(0x1000)));
#endif
  }
  ...
  void test_command_queue_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<command_queue_info_t>(0x1234)), detail::enum2hex(static_cast<command_queue_info_t>(0x1234)));
  }
  ...
  void test_mem_flags_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<mem_flags_t>(0x1800)), detail::enum2hex(static_cast<mem_flags_t>(0x0800)) + " | " + detail::enum2hex(static_cast<mem_flags_t>(0x1000)));
  }
  ...
  void test_mem_migration_flags_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<mem_migration_flags_t>(0x1200)), detail::enum2hex(static_cast<mem_migration_flags_t>(0x0200)) + " | " + detail::enum2hex(static_cast<mem_migration_flags_t>(0x1000)));
#endif
  }
  ...
  void test_channel_order_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<channel_order_t>(0x1234)), detail::enum2hex(static_cast<channel_order_t>(0x1234)));
  }
  ...
  void test_channel_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<channel_type_t>(0x1234)), detail::enum2hex(static_cast<channel_type_t>(0x1234)));
  }
  ...
  void test_mem_object_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<mem_object_type_t>(0x1234)), detail::enum2hex(static_cast<mem_object_type_t>(0x1234)));
  }
  /** // doc: test_mem_info_t() {{{
   * \todo Write documentation
   */ // }}}
  void test_mem_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<mem_info_t>(0x1234)), detail::enum2hex(static_cast<mem_info_t>(0x1234)));
  }
  ...
  void test_image_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<image_info_t>(0x1234)), detail::enum2hex(static_cast<image_info_t>(0x1234)));
  }
  ...
  void test_addressing_mode_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<addressing_mode_t>(0x1234)), detail::enum2hex(static_cast<addressing_mode_t>(0x1234)));
  }
  ...
  void test_filter_mode_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<filter_mode_t>(0x1234)), detail::enum2hex(static_cast<filter_mode_t>(0x1234)));
  }
  ...
  void test_sampler_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<sampler_info_t>(0x1234)), detail::enum2hex(static_cast<sampler_info_t>(0x1234)));
  }
  ...
  void test_map_flags_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<map_flags_t>(0x1200)), detail::enum2hex(static_cast<map_flags_t>(0x0200)) + " | " + detail::enum2hex(static_cast<map_flags_t>(0x1000)));
  }
  ...
  void test_program_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<program_info_t>(0x1234)), detail::enum2hex(static_cast<program_info_t>(0x1234)));
  }
  ...
  void test_program_build_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<program_build_info_t>(0x1234)), detail::enum2hex(static_cast<program_build_info_t>(0x1234)));
  }
  ...
  void test_program_binary_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<program_binary_type_t>(0x1200)), detail::enum2hex(static_cast<program_binary_type_t>(0x0200)) + " | " + detail::enum2hex(static_cast<program_binary_type_t>(0x1000)));
#endif
  }
  ...
  void test_build_status_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<build_status_t>(0x1234)), detail::enum2hex(static_cast<build_status_t>(0x1234)));
  }
  ...
  void test_kernel_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_info_t>(0x1234)), detail::enum2hex(static_cast<kernel_info_t>(0x1234)));
  }
  ...
  void test_kernel_arg_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_arg_info_t>(0x1234)), detail::enum2hex(static_cast<kernel_arg_info_t>(0x1234)));
#endif
  }
  ...
  void test_kernel_arg_address_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_arg_address_qualifier_t>(0x1234)), detail::enum2hex(static_cast<kernel_arg_address_qualifier_t>(0x1234)));
#endif
  }
  ...
  void test_kernel_arg_access_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_arg_access_qualifier_t>(0x1234)), detail::enum2hex(static_cast<kernel_arg_access_qualifier_t>(0x1234)));
#endif
  }
  ...
  void test_kernel_arg_type_qualifier_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_arg_type_qualifier_t>(0x1200)), detail::enum2hex(static_cast<kernel_arg_type_qualifier_t>(0x0200)) + " | " + detail::enum2hex(static_cast<kernel_arg_type_qualifier_t>(0x1000)));
#endif
  }
  ...
  void test_kernel_work_group_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<kernel_work_group_info_t>(0x1234)), detail::enum2hex(static_cast<kernel_work_group_info_t>(0x1234)));
  }
  ...
  void test_event_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<event_info_t>(0x1234)), detail::enum2hex(static_cast<event_info_t>(0x1234)));
  }
  ...
  void test_command_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<command_type_t>(0x1234)), detail::enum2hex(static_cast<command_type_t>(0x1234)));
  }
  ...
  void test_command_exec_status_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<command_exec_status_t>(0x1234)), detail::enum2hex(static_cast<command_exec_status_t>(0x1234)));
  }
  ...
  void test_buffer_create_type_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<buffer_create_type_t>(0x1234)), detail::enum2hex(static_cast<buffer_create_type_t>(0x1234)));
#endif
  }
  ...
  void test_profiling_info_t( )
  {
    ...
    TS_ASSERT_EQUALS(std::to_string(static_cast<profiling_info_t>(0x1234)), detail::enum2hex(static_cast<profiling_info_t>(0x1234)));
  }
};

#endif /* CLXX_COMMON_TO_STRING_T_H_INCLUDED */
