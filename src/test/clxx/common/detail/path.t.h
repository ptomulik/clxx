...
// clxx/common/detail/path.t.h

/** // doc: clxx/common/detail/path.t.h {{{
 * \file clxx/common/detail/path.t.h
 * \todo Write documentation
 */ // }}}
#ifndef CLXX_COMMON_DETAIL_PATH_T_H_INCLUDED
#define CLXX_COMMON_DETAIL_PATH_T_H_INCLUDED
...
#endif /* CLXX_COMMON_DETAIL_PATH_T_H_INCLUDED */
