...
def prepare_cpp_output(resultdict, **kw):
    ...
    outputlist.append(r'')
    outputlist.append(r'// clxx/b5d/config_cl_functions.hpp')
    outputlist.append(r'')
    outputlist.append(r'/** // doc: clxx/b5d/config_cl_functions.hpp {{{')
    outputlist.append(r'* \file clxx/b5d/config_cl_functions.hpp')
    outputlist.append(r'* \todo Write documentation for clxx/b5d/config_cl_functions.hpp')
    outputlist.append(r'*/ // }}}')
    outputlist.append(r'#ifndef CLXX_B5D_CONFIG_CL_FUNCTIONS_HPP_INCLUDED')
    outputlist.append(r'#define CLXX_B5D_CONFIG_CL_FUNCTIONS_HPP_INCLUDED')
    outputlist.append(r'')
    outputlist.append(r'#include <clxx/b5d/config_params.hpp>')
    outputlist.append(r'')
    outputlist.append(r'/* !!!!!!!!!!!!!!!!!!!!!!!!! WARNING !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */')
    outputlist.append(r'/*    FILE GENERATED WITH bin/config-cl-functions.py. DO NOT MODIFY    */')
    outputlist.append(r'/* !!!!!!!!!!!!!!!!!!!!!!!!! WARNING !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */')
    outputlist.append(r'')
    exists = []
    ...
    outputlist.append(r'')
    outputlist.append(r'#endif /* CLXX_B5D_CONFIG_CL_FUNCTIONS_HPP_INCLUDED */')
...
default_logfile = os.path.join(tmpdir, 'config-cl-functions.log')
